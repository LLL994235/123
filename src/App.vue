<template>
  <div id="app">
      ...
      <div class="header">
        <span>REALSTATE地产，您居家置业最信赖的地产！</span>
        <div class="img">
      ...
      <div id="nav">
        ...
        <div class="con">
          ...
          <router-link to="/lou">楼市动态</router-link>
          <router-link to="/lian">联系我们</router-link>
        </div>
        <div class="right">
          <div><img src="./images/1.png" alt=""><span>008-6666 66666</span></div>
          <button>咨询电话</button>
        </div>
      </div>
    ...
    <router-view/>
    <div class="footer">
      地产REALSTATE  © 2020 All Rights Reserved.
    </div>
  </div>
</template>
